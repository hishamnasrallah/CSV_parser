import os
import requests
from app.api.models import Parser, MapperTask, CeleryTaskStatus, Profile, \
    MapperProfile, Status, \
    FileHistory, FileHistoryFailedRows
from app.api.repositories.common import CRUD
from app.api.repositories.csv import \
    update_file_history_rows_number_based_on_status, create_failed_row, \
    update_failed_row
...
def add_tasks(file_id, file_path, file_name, frequency, process_id, company_id,
    ...
    :param process_id:  the process id in the core app
...
def send_collected_data(company_id, process_id, row_number, history_id, data,
    ...
    try:
        ...
        row_history = db.query(FileHistoryFailedRows).filter(
            FileHistoryFailedRows.id == row_history_id)
