...
class CSVHelper:
    ...
    def connect_to_sftp(self):
        ...
        with SFTPHelper() as sftp_helper:
            ...
            for file_name in new_files_names:
                ...
                # TODO: use this function copy_file_to_tmp_sftp instead
                #  of copy_file_to_tmp_without_sftp
                ...
                x = self.send_data(self.company_id, self.process_id,
                                   mapped_data)
                response = {"file_name_as_received": self.file_name_as_received,
                            "core_response": x}
                return response
    ...
    def send_data(self, company_id, process_id, data):
        ...
        for idx, _obj in enumerate(data):
            response = send_collected_data.delay(company_id=company_id,
                                                 process_id=process_id,
                                                 data=_obj,
                                                 row_number=idx + 1,
                                                 history_id=self.history_rec.id)
    ...
    def main(self):
        self.get_tmp_path()
        # TODO: use this function connect_to_sftp instead of commented it
